...
import { CausalGraph, pcAlgorithm, fisherZTest } from '../graph/index.js';
...
describe('fisherZTest', () => {
  ...
  it('conditional independence blocks indirect causation', () => {
    // X → Z → Y: X and Y should be approximately independent given Z
      const n = 300;
      ...
      // Conditioning on Z should substantially increase p-value
